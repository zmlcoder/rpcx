...
public class RpcxClientBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		RootBeanDefinition beanDefinition = new RootBeanDefinition(RpcxClientFactoryBean.class);
